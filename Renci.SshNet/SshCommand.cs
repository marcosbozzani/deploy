...
namespace Renci.SshNet
{
    ...
    public class SshCommand : IDisposable
    {
        ...
        /// <summary>
        /// Creates a stream for ouput
        /// </summary>
        public Action<byte[], Encoding> OutputDataReceived { get; set; }

        /// <summary>
        /// Creates a stream for extended ouput
        /// </summary>
        public Action<byte[], Encoding> ExtendedOutputDataReceived { get; set; }
        ...
        private void Channel_ExtendedDataReceived(object sender, ChannelExtendedDataEventArgs e)
        {
            ...
            if (ExtendedOutputDataReceived != null)
            {
                ExtendedOutputDataReceived.Invoke(e.Data, _encoding);
            }
